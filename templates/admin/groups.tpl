...
<ul class="nav nav-tabs mt-3">
  ...
  <li class="nav-item">
      <a class="nav-link active" id="groups-tab"  href="/admin/groups" role="tab" aria-controls="groups" aria-selected="true">Groups</a>
  </li>
</ul>
<div class="tab-content p-3" id="adminTabContent">
    <div class="tab-pane active" id="groups" role="tabpanel" aria-labelledby="groups-tab">...</div>
</div>
