...
* the SQLite database file (`data.db` by default, see [Configuration reference →](configuration-reference.md) for how to change its location), holding every app, user, and group.
