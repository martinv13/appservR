...
lead: "Every config.yml setting and command-line flag AppservR reads."
...
| Variable | Effect |
|---|---|
| `APPSERVR_AUTH_SECRET` | Signing secret for login sessions. See [Running in production →]({{< relref "production-considerations" >}}) for why you'll want to set this. |
