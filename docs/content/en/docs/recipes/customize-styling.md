...
All built-in pages, such as signup, login, error pages, are embedded in AppservR's executable. However, they can be changed easily if you want to translate them to your language, add your company's logo, etc.
